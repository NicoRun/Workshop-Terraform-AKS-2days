...
terraform {
  ...
  backend "azurerm" {
    resource_group_name  = "RG-WS-Terra-NMMN"         # mettre ici le nom du resource group de vos ressource
    storage_account_name = "terraformnmn"      # mettre le nom du compte de stockage créer dans le lab 1
